export const translations = {
  en: {
    ...
    whyChoose: {
      ...
      card2Text: 'One-on-one guidance patterns ready for future backend scheduling and doubt rooms.',
      card3Title: 'Deep Analytics',
      card3Text: 'Progress states and quiz results are kept client-side now and can move to APIs later.',
      card4Title: 'Smart Learning',
      card4Text: 'YouTube lessons, notes, quizzes and mock-test style practice in one front-end flow.',
